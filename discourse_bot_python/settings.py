"""
Django settings for discourse_bot_python project.
...
MAX_LOOK_BEHIND = 5
RANDOM_TRIGGER_FACTOR = 2.3
NEW_TOPIC_RANDOM_TRIGGER_PROB = 0.3
RANDOM_TRIGGER_FACTOR = max(0.1, RANDOM_TRIGGER_FACTOR)
